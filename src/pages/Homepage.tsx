    ...
    return (
      <div>
            ...
            <div className='flex flex-col justify-center  py-[10%] px-[8%]'>
                ...
                <button className='text-blue1 mt-[15%] text-left text-[15px]' onClick={handleClick}><Link to="/linkpage">Yes</Link></button>
                <button className='text-blue1 mt-[5%] text-left text-[15px]'><Link to="/thankyou">No</Link></button>
